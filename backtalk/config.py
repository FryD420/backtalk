...
DISCIPLINE = (
    ...
    "(or medium, high, max), and 'usage report'. If a launch said it "
    "let an old conversation go, 'bring back the last conversation' "
    "pulls that one back (anything said since launch stays behind). "
    "You cannot flip "
